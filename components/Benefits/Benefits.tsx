  ...
  return (
    <section className={css.benefits}>
      <div className="container">
        <h2 className={clsx(css.benefitsTitle, css.visuallyHidden)}>
          Benefits
        </h2>
        <div className={css.benefitsContainer}>
          ...
          <p className={css.benefitsContainerText}>
            ...
            а власники — зручно керувати своїми оголошеннями.
            <br />
            Ми створили сервіс, щоб зробити процес оренди простим, доступним і
            вигідним для всіх.
          </p>
        </div>
        <ul className={css.benefitsList}>
          <li className={css.benefitsListItem}>
            ...
            <h3 className={css.benefitsListItemTitle}>
