...
import { Tool, BookedDate } from "@/types/tool";
...
function DateField({
  ...
  // перетворюємо масив бронювань у масив окремих дат
  const excluded = bookedDates.flatMap((range) => {
  ...
  // скорочення назв днів тижня українською
  ...
  return (
    <div className={css.control}>
      ...
      <DatePicker
        ...
        excludeDates={excluded} // ← заброньовані дати стають неактивними
      />
